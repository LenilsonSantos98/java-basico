...
public class ProcessoSeletivo {
    ...
    static void imprimirSeleciodandos (){
        String [] candidatos = {"FELIPE", "MARCIA", "JULIA", "PAULO","AUGUSTO",};
        System.out.println("Imprimindo a lista de candidatos imformando o incice do elemento");
        for(int indice = 0; indice < candidatos.length; indice++){
            System.out.println("O candidato de numero " + (indice+1) + "é " + candidatos[indice]);// entre parenteses 'indice+1' para contar a partr de 1.
        }
